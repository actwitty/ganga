...
App.LimitedValueList =
                    'browser' : {'Chrome':'Chrome','OmniWeb':'OmniWeb','Safari':'Apple Safari','Opera':'Opera','Firefox':'Firefox','Explorer':'Internet Explorer'} 
                    ...
                    'referrer[host]' : { 't.co': 'Twitter', 'facebook.com' : 'Facebook', 'nyt.com' : 'Newyork Times' } 
