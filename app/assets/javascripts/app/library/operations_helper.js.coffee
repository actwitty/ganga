...
App.LimitedValueList = 
                    ...
                    'operatingsystem' : { 'windows' : 'Microsoft Windows', 'ubuntu' : 'Ubuntu Linux', 'mac' : 'Apple Mac' }
                    'device[type]' : { 'tab': 'Tablet', 'pc' : 'PC', 'mob' : 'Mobile' }
                    'referrer[name]' : { 't.co': 'Twitter', 'facebook.com' : 'Facebook', 'nyt.com' : 'Newyork Times' } 
                    'device[name]' : {'android' : 'Android', 'ipad' : 'IPad', 'ipadmini' : 'IPad Mini', 'Nexus' : 'Google Nexus' }
